...
class Reading(db.Model):
  ...
  def __init__(self, temp_mean, pressure_mean, humidity_mean, tvoc_mean, sensor_id, baseline_temp, gas_baseline):
...
class ReadingSchema(ma.Schema):
  class Meta:
    fields = ('reading_id','temp_mean', 'pressure_mean', 'humidity', 'tvoc_mean', 'sensor_id', 'timestamp', 'baseline_temp', 'gas_baseline')
...
def post_reading(sensor_id):
  ...
  new_reading = Reading(temp_mean, pressure_mean, humidity_mean, tvoc_mean, sensor_id, baseline_temp, gas_baseline)
